      ...
      <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <div class="collapse navbar-collapse"  id="navbarNavDropdown">
                  <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                              <a class="nav-link " href="/web/home">Web</a>
                        </li>
                        <li class="nav-item">
            ...
            <ul class="navbar-nav flex-row ml-md-auto d-none d-md-flex">
                  <li class="nav-item">
                        <a class="nav-link p-2" href="https://github.com/" target="_blank" rel="noopener" aria-label="GitHub">
                  ...
                  <li class="nav-item">
                        <a class="nav-link p-2" href="https://join.slack.com/t/drible-interns/shared_invite/enQtMzI5ODg3MDI2Mjk0LTY1N2Q5YzdkM2Q2NjI3YTc0MWZkNGNmNmJiNmYwZGE0ZTY0NzNjYzRhODg2MTE4ODEwZjRhOTc5NDMyMDY1MTA" target="_blank" rel="noopener" aria-label="Slack">
