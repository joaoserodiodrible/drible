<main class="bd-masthead" id="content" role="main">
  <div class="container">
    ...
    <h2>Testando o XAMPP</h2>

    <ul>
      <li><p class="lead">No painel de controle do XAMPP, clique em "Iniciar" em "Ações" para o módulo do Apache. Isso instrui o XAMPP a iniciar o servidor da web Apache.</p></li>
      <li><p class="lead">Abra seu navegador da Web e digite: http: // localhost ou 127.0.0.1</p></li>
      <li><p class="lead">Selecione o idioma na tela inicial.</p></li>
      <li><p class="lead">Selecione seu idioma na tela inicial.</p></li>
    </ul>
