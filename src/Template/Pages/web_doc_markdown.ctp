<main class="bd-masthead" id="content" role="main">
      <div class="container">
            ...
            <p> You can use the <a href="https://github.com/agencia-drible/drible/edit/master/README.md">editor on GitHub</a> to maintain and preview the content for your website in Markdown files.</p>
      ...
      <p>Your Pages site will use the layout and styles from the Jekyll theme you have selected in your <a href="https://github.com/popperz0r/sys-config/settings">repository settings</a>. The name of this theme is saved in the Jekyll <code class="highlighter-rouge">_config.yml</code> configuration file.</p>
